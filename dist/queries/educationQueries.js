...
export async function createNewEducation(userId, educationData) {
...
export async function updateUserWithEducation(userId, educationId) {
    return await User.findByIdAndUpdate(userId, { $push: { education: educationId } }, { new: true });
}
...
export async function deleteEducationById(educationId) {
    return await Education.findByIdAndDelete(educationId);
}
// Function to remove education reference from user
export async function removeEducationFromUser(userId, educationId) {
    return await User.findByIdAndUpdate(userId, { $pull: { education: educationId } }, { new: true });
}
